...
<html>
    ...
    <div class="w3-main w3-content" style="max-width:1000px; margin-top:20px">
        <div class="w3-container">
            ...
            <h2>3rd Year Student Information</h2> 
           <hr>
            ...
            <img src="images_st/<?php echo $row['st_img']; ?>" style="width:220px;height:290px; margin-top:20px" 
                 ...
                 <hr class='w3-white'>รหัสนักศึกษา : <?php echo $row['st_code']; ?> 
                 <hr class='w3-white'>ติดต่อ : <?php echo $row['st_contact']; ?> 
                 <hr class='w3-white'>ที่อยู่ : <?php echo $row['st_address']; ?>
                 <hr class='w3-white'>จบจาก : <?php echo $row['st_school']; ?> 
                 <hr class='w3-white'>ชั้นปี : <?php echo $row['class_id']; ?>
                 <hr class='w3-white'>" class="img-thumbnail">
